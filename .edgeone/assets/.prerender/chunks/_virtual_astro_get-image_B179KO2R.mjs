...
import { r as DEFAULT_HASH_PROPS } from "./_astro_content_BILJKZrF.mjs";
import { c as isRemoteImage, i as inferRemoteSize, l as resolveSrc, n as isLocalService, o as resolveDefaultOutputFormat, s as isESMImportedImage } from "./service_Cjeqxhec.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_Cq5if6mg.mjs").catch((e) => {
