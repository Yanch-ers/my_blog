...
import { B as RenderUndefinedEntryError, Y as UnknownContentCollectionError, t as AstroError } from "./errors_UeLp8ga4.mjs";
import { S as unescapeHTML, T as createComponent, b as createHeadAndContent, f as renderTemplate, h as generateCspDigest, n as renderScriptElement, o as renderComponent, r as renderUniqueStylesheet, t as spreadAttributes } from "./server_BzLvcQuV.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_DmYcjrCC.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_B179KO2R.mjs");
