import { B as RenderUndefinedEntryError, Y as UnknownContentCollectionError, ct as prependForwardSlash, lt as removeBase, ot as isRemotePath, t as AstroError } from "./errors_DD4ZP9r6.mjs";
import { S as unescapeHTML, T as createComponent, b as createHeadAndContent, f as renderTemplate, h as generateCspDigest, n as renderScriptElement, o as renderComponent, r as renderUniqueStylesheet, t as spreadAttributes } from "./server_CUCY0GF4.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_CLcyejEI.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_CuDR1vm7.mjs");
...
//#endregion
export { getDate as a, getTags as c, renderEntry as d, DEFAULT_HASH_PROPS as f, __exportAll as h, getAllTags as i, readingTime as l, VALID_SUPPORTED_FORMATS as m, getAllPosts as n, getSubCategoryName as o, DEFAULT_OUTPUT_FORMAT as p, getAllSubCategories as r, getSummary as s, formatDate as t, getCollection as u };
