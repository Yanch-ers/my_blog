import { f as DEFAULT_HASH_PROPS } from "./content_Yf5gNan9.mjs";
...
import { c as isRemoteImage, i as inferRemoteSize, l as resolveSrc, n as isLocalService, o as resolveDefaultOutputFormat, s as isESMImportedImage } from "./service_BR6VMDwM.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_DOimsvIQ.mjs").catch((e) => {
