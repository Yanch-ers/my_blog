import { f as DEFAULT_HASH_PROPS } from "./content_DVRZEqeP.mjs";
import { c as ExpectedImage, l as ExpectedImageOptions, ot as isRemotePath, t as AstroError, u as ExpectedNotESMImage, x as InvalidImageService, z as RemoteImageNotAllowed } from "./errors_DD4ZP9r6.mjs";
import { t as isRemoteAllowed } from "./remote_BgpFkaRQ.mjs";
import { c as isRemoteImage, i as inferRemoteSize, l as resolveSrc, n as isLocalService, o as resolveDefaultOutputFormat, s as isESMImportedImage } from "./service_D8yI1hi1.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_CsB-j-qz.mjs").catch((e) => {
