...
//#endregion
export { UnsupportedImageConversion as $, MissingGetFontFileRequestUrl as A, PageNumberParamNotFound as B, InvalidGetStaticPathsReturn as C, LocalsReassigned as D, LocalsNotAnObject as E, NoImageMetadata as F, ResponseSentError as G, PrerenderDynamicEndpointPathCollide as H, NoMatchingImport as I, SessionStorageSaveError as J, RewriteWithBodyUsed as K, NoMatchingRenderer as L, MissingMediaQueryDirective as M, MissingSharp as N, MiddlewareNoDataOrNextCalled as O, NoClientOnlyHint as P, UnknownContentCollectionError as Q, NoMatchingStaticPathFound as R, InvalidGetStaticPathsEntry as S, LocalImageUsedWrongly as T, RemoteImageNotAllowed as U, PrerenderClientAddressNotAvailable as V, ReservedSlotName as W, UnableToLoadLogger as X, StaticClientAddressNotAvailable as Y, UnavailableAstroGlobal as Z, GetStaticPathsInvalidRouteParam as _, trimSlashes as _t, CacheNotEnabled as a, collapseDuplicateTrailingSlashes as at, IncompatibleDescriptorOptions as b, ExpectedImage as c, isInternalPath as ct, FailedToFetchRemoteImageDimensions as d, prependForwardSlash as dt, UnsupportedImageFormat as et, FontFamilyNotFound as f, removeBase as ft, GetStaticPathsExpectedParams as g, slash as gt, GetEntryDeprecationError as h, removeTrailingForwardSlash as ht, AstroResponseHeadersReassigned as i, collapseDuplicateSlashes as it, MissingImageDimension as j, MiddlewareNotAResponse as k, ExpectedImageOptions as l, isRemotePath as lt, ForbiddenRewrite as m, removeQueryString as mt, ActionNotFoundError as n, appendForwardSlash as nt, ClientAddressNotAvailable as o, fileExtension as ot, FontFileUrlNotFound as p, removeLeadingForwardSlash as pt, SessionStorageInitError as q, ActionsReturnedInvalidDataError as r, collapseDuplicateLeadingSlashes as rt, EndpointDidNotReturnAResponse as s, hasFileExtension as st, AstroError as t, i18nNoLocaleFoundInPath as tt, ExpectedNotESMImage as u, joinPaths as ut, GetStaticPathsRequired as v, InvalidImageService as w, InvalidComponentArgs as x, ImageMissingAlt as y, OnlyResponseCanBeReturned as z };
