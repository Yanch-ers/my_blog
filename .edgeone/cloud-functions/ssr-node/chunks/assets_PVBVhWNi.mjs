...
import { $ as UnsupportedImageConversion, E as LocalImageUsedWrongly, F as NoImageMetadata, M as MissingImageDimension, T as InvalidImageService, U as RemoteImageNotAllowed, d as ExpectedNotESMImage, et as UnsupportedImageFormat, f as FailedToFetchRemoteImageDimensions, l as ExpectedImage, n as AstroError, t as shorthash, u as ExpectedImageOptions, x as IncompatibleDescriptorOptions } from "./shorthash_CzXjtOZy.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_hRtfuOL2.mjs").catch((e) => {
