...
import { A as MissingGetFontFileRequestUrl, U as RemoteImageNotAllowed, c as ExpectedImage, f as FontFamilyNotFound, l as ExpectedImageOptions, t as AstroError, u as ExpectedNotESMImage, w as InvalidImageService, y as ImageMissingAlt } from "./errors_Zccn8hBz.mjs";
import { S as createComponent, g as addAttribute, m as maybeRenderHead, t as spreadAttributes, u as renderTemplate, x as createAstro, y as unescapeHTML } from "./server_D5dh6Vmy.mjs";
import { t as DEFAULT_HASH_PROPS } from "./consts_Bx4_lkUX.mjs";
import { a as fetchWithRedirects, c as isESMImportedImage, i as inferRemoteSize$1, l as isRemoteImage, n as isLocalService, s as resolveDefaultOutputFormat, u as resolveSrc } from "./service_DY6ALGY_.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_DxI8eK_I.mjs").catch((e) => {
